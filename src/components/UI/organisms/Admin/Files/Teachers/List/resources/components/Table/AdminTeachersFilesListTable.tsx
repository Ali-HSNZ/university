...
import { deleteTeacherFileFn } from '@api/delete-teacher-file'
...
import { type IAdminTeachersFilesListTableProps } from './resources'

const Table: FC<IAdminTeachersFilesListTableProps> = ({ data }) => {
    ...
    const { mutate } = useMutation({
        mutationFn: ({ fileName, fileId }: { fileName: string; fileId: number }) =>
            deleteTeacherFileFn({ fileName, fileId }),
