...
const updateTeacherFormSchema = Yup.object({
    ...
    pass: Yup.string()
        ...
        .min(6, 'رمزعبور نمی‌تواند کم تر از 6 کاراکتر باشد')
        .max(20, 'رمزعبور نمی‌تواند بیشتر از 20 نویسه باشد'),
    address: Yup.string()
...
export default updateTeacherFormSchema
